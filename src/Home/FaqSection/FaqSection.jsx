...
const FaqSection = () => {
  return (
    <>
      ...
      ></SectionTitle>
      <div className="join join-vertical w-full lg:w-11/12 ml-4 border-2 border-borderColor">
        <div className="collapse collapse-arrow join-item border-2 border-borderColor">
          ...
          <div className="collapse-content">
            <p className="font-semibold">
              Click on the "Sign Up" button on the homepage. Select whether you
              want to register as a Worker or Buyer, fill in your details, and
        ...
        <div className="collapse collapse-arrow join-item border-borderColor border-2">
          ...
          <div className="collapse-content">
            <p className="font-semibold">
              Tasks include social media engagement, surveys, content creation,
              app testing, data entry, and more. The variety of tasks depends on
              Buyers' posted requirements.
            </p>
          </div>
        </div>
        <div className="collapse collapse-arrow join-item border-borderColor border-2">
        ...
        <div className="collapse collapse-arrow join-item border-borderColor border-2">
          ...
          <div className="collapse-content">
            <p className="font-semibold">
              ...
              allows you to post tasks as a Buyer while also completing tasks as
              a Worker.
            </p>
          </div>
        </div>
        <div className="collapse collapse-arrow join-item border-borderColor border-2">
          ...
          <div className="collapse-content">
            <p className="font-semibold">
              You can contact our support team through the "Contact Us" page or
              email us directly. We are here to help you with any
